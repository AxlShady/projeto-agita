...
function TabPagamentos({ athletes }) {
    ...
    const fetchPayments = async () => {
        try {
            ...
            const res = await fetch("https://projeto-agita.onrender.com/payments");
            if (res.ok) {
    ...
    const handleCreatePayment = async (e) => {
        ...
        try {
            ...
            const response = await fetch("https://projeto-agita.onrender.com/payments", {
                method: "POST",
    ...
    const handleDeletePayment = async (id) => {
        ...
        try {
            const response = await fetch(`https://projeto-agita.onrender.com/payments/${id}`, {
                method: "DELETE"
            });
            if (response.ok) {
