...
function TabNotas({ athletes, events }) {
  ...
  const fetchGrades = async () => {
      try {
          const res = await fetch("https://projeto-agita.onrender.com/grades");
          if(res.ok) {
  ...
  const handleCreateGrade = async (e) => {
      ...
      try {
          const response = await fetch("https://projeto-agita.onrender.com/grades", {
              method: "POST",
  ...
  const handleDeleteGrade = async (id) => {
      ...
      try {
          const response = await fetch(`https://projeto-agita.onrender.com/grades/${id}`, { method: "DELETE" });
