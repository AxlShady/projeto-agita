...
function AthleteDashboard() {
  ...
  useEffect(() => {
    ...
    if (storedUser) {
      ...
      // Buscando dados...
      fetch(`https://projeto-agita.onrender.com/events/athlete/${parsedUser.id}`)
        .then((res) => res.json())
        .then((data) => setEvents(data || []))
        .catch((err) => console.error(err));

      fetch(`https://projeto-agita.onrender.com/grades/athlete/${parsedUser.id}`)
        .then((res) => res.json())
        .then((data) => setGrades(data || []))
        .catch((err) => console.error(err));

      fetch(`https://projeto-agita.onrender.com/payments/athlete/${parsedUser.id}`)
        .then((res) => res.json())
